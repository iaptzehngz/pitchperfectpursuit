...
function after_physics()
    Instance_Update_Pos()
    Dref_Crosshair_Out[1] = 0 -- Rot_X for the crosshair
    Dref_Crosshair_Out[2] = Dref_Crosshair_In[2]    -- Rot_Y
    Dref_Crosshair_Out[3] = 0 -- Rot_Z for flight path
    Dref_Crosshair_Out[4] = Dref_Crosshair_In[4]  -- X
    Dref_Crosshair_Out[5] = Dref_Crosshair_In[5]  -- Y
    Dref_Crosshair_Out[6] = Dref_Crosshair_In[6]  -- Z
